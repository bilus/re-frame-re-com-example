...
if(!((function (){var G__30916 = app_db;
if(G__30916){
...
return G__30916.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__30916.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__30916);
} else {
return false;
}
}
...
var G__30921__i = 0, G__30921__a = new Array(arguments.length -  0);
while (G__30921__i < G__30921__a.length) {G__30921__a[G__30921__i] = arguments[G__30921__i + 0]; ++G__30921__i;}
  args = new cljs.core.IndexedSeq(G__30921__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__30922){
var args = cljs.core.seq(arglist__30922);
...
return cljs.core.get_in.call(null,new_db,p1__30923_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__30924_SHARP_){
return cljs.core.get_in.call(null,db,p1__30924_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__30925__i < G__30925__a.length) {G__30925__a[G__30925__i] = arguments[G__30925__i + 2]; ++G__30925__i;}
  in_paths = new cljs.core.IndexedSeq(G__30925__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__30926){
var f = cljs.core.first(arglist__30926);
arglist__30926 = cljs.core.next(arglist__30926);
var out_path = cljs.core.first(arglist__30926);
var in_paths = cljs.core.rest(arglist__30926);
...
//# sourceMappingURL=middleware.js.map?rel=1445200146118