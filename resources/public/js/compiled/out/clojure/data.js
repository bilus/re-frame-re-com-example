...
return cljs.core.reduce.call(null,(function (result,p__30931){
var vec__30932 = p__30931;
var k = cljs.core.nth.call(null,vec__30932,(0),null);
var v = cljs.core.nth.call(null,vec__30932,(1),null);
...
var vec__30934 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__30934,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__30934,(1),null);
var ab = cljs.core.nth.call(null,vec__30934,(2),null);
 ...
 */
clojure.data.EqualityPartition = (function (){var obj30939 = {};
return obj30939;
})();
...
if((function (){var and__22737__auto__ = x;
...
var x__23385__auto__ = (((x == null))?null:x);
return (function (){var or__22749__auto__ = (clojure.data.equality_partition[goog.typeOf(x__23385__auto__)]);
if(or__22749__auto__){
return or__22749__auto__;
} else {
var or__22749__auto____$1 = (clojure.data.equality_partition["_"]);
 ...
 * Implementation detail. Subject to change.
 */
clojure.data.Diff = (function (){var obj30941 = {};
return obj30941;
})();
...
if((function (){var and__22737__auto__ = a;
if(and__22737__auto__){
...
var x__23385__auto__ = (((a == null))?null:a);
return (function (){var or__22749__auto__ = (clojure.data.diff_similar[goog.typeOf(x__23385__auto__)]);
if(or__22749__auto__){
return or__22749__auto__;
} else {
var or__22749__auto____$1 = (clojure.data.diff_similar["_"]);
if(or__22749__auto____$1){
return or__22749__auto____$1;
} else {
...
if((function (){var G__30942 = x;
if(G__30942){
var bit__23423__auto__ = (G__30942.cljs$lang$protocol_mask$partition0$ & (1024));
if((bit__23423__auto__) || (G__30942.cljs$core$IMap$)){
return true;
} else {
if((!G__30942.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__30942);
} else {
return false;
}
}
...
if((function (){var G__30943 = x;
if(G__30943){
var bit__23423__auto__ = (G__30943.cljs$lang$protocol_mask$partition0$ & (4096));
if((bit__23423__auto__) || (G__30943.cljs$core$ISet$)){
return true;
} else {
if((!G__30943.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__30943);
} else {
return false;
}
}
...
if((function (){var G__30944 = x;
if(G__30944){
var bit__23423__auto__ = (G__30944.cljs$lang$protocol_mask$partition0$ & (16777216));
if((bit__23423__auto__) || (G__30944.cljs$core$ISequential$)){
return true;
} else {
if((!G__30944.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__30944);
} else {
return false;
}
}
...
return (function (){var G__30945 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__30945) {
case "map":
...
//# sourceMappingURL=data.js.map?rel=1445200146477